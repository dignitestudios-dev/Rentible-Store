...
const RentalCancelConfirm = ({ isOpen, onRequestClose, onConfirm }) => {
  return (
    <Modal
      isOpen={isOpen}
    ...
    >
      <div className="bg-white p-6 rounded-[16px] shadow-lg max-w-lg w-[461px]  items-center flex flex-col justify-center text-center">
        ...
        <p className="text-[#3C3C43D9] text-[18px] font-normal leading-[27px] mb-6">
          Are you sure you want to cancel this booking? <br /> Please let us
          know why by providing a reason for the cancellation.
        </p>
...
export default RentalCancelConfirm;
