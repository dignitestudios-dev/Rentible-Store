...
const CsvProductTimePicker = ({
  ...
  useEffect(() => {
    pickupTime && !isDropOff && setSelectedTime(null);
  }, [isChanged]);
    ...
    <div className="w-full h-auto flex flex-col justify-start items-start gap-2">
      ...
      <div className="relative w-full">
        ...
        <button
          ...
          className={` px-4 py-2 text-left   w-full h-[49px] rounded-[8px] outline-none focus:border bg-[#f8f8f8]/[0.6] disabled:bg-gray-200   focus:outline-none ${
...
export default CsvProductTimePicker;
