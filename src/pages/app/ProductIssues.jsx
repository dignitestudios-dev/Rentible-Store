...
import ProductIssueModal from "../../components/app/product_issue/ProductIssueModal";
  ...
  const getIssues = async (query = "") => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `/report/booking?type=rental&search=${query}${
          initialDate
  ...
  return (
    <div className="w-full h-auto   flex flex-col  py-4 px-2 lg:px-6 justify-start items-start gap-6">
      ...
      <div className="w-full overflow-x-auto lg:overflow-x-hidden flex flex-col justify-start items-start">
        <div className="min-w-[960px] w-full border-t border-x h-[49px] bg-[#FCFDFD] border-gray-300 rounded-t-[14px] grid grid-cols-12 gap-3 ">
          ...
          <span className="w-full col-span-4 flex items-center justify-start h-full ">
            <span className="text-[13px] font-medium">Issue</span>
          </span>
              ...
              return (
                ...
                >
                  ...
                  <span className="w-full col-span-2 flex items-center gap-2 justify-start h-full ">
                    ...
                    <span className="text-[13px] font-normal">
                      {issue?.booking?.product?.name?.length > 15
                        ? issue?.booking?.product?.name?.slice(0, 15) + "..."
