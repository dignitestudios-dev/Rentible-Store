...
const RequestListSkeleton = () => {
  return (
    <div className="w-full grid grid-cols-12 gap-3 px-4 h-[77px] text-[#202224]">
      ...
      <span className="w-full col-span-2 flex items-center gap-2 justify-start h-full">
        <div className="w-[44px] h-[44px] shrink-0 bg-gray-300 rounded-full flex items-center justify-center animate-pulse"></div>
